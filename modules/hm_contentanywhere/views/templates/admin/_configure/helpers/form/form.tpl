			...
			{foreach from=$languages item=language}
				...
				<div class="form-group">
					<div class="col-lg-6">
						...
						<input type="hidden" name="{$input.name}_old_{$language.id_lang}" class="hide" value="{$fields_value[$input.name][$language.id_lang]}" />
				...
				<div class="form-group">
					<span class="switch prestashop-switch fixed-width-lg">
						<input type="radio" name="image_delete_{$language.id_lang}" id="random_on_{$language.id_lang}" value="1" />
						<label for="random_on_{$language.id_lang}">{l s='Yes' d='Admin.Global'}</label>
						<input type="radio" name="image_delete_{$language.id_lang}" id="random_off_{$language.id_lang}" value="0" checked="checked" />
						<label for="random_off_{$language.id_lang}">{l s='No' d='Admin.Global'}</label>
						<a class="slide-button btn"></a>
					</span>
					<p class="help-block">{l s='Delete this image' mod='hm_productsbycategory'}</p>
				</div>
				<div class="form-group">
