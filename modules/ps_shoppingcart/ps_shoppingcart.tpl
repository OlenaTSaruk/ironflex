  ...
  <div class="blockcart cart-preview {if $cart.products_count > 0}active{else}inactive{/if}" data-refresh-url="{$refresh_url}">
    <div class="header">
      <a class="link-cart" href="{$cart_url}" rel="nofollow">    
        ...
        <span><img src="{$urls.img_url}cart.svg" alt="cart" /></span>
      </a>
      ...
      {else}
        <a rel="nofollow" aria-label="{l s='Shopping cart link containing %nbProducts% product(s)' sprintf=['%nbProducts%' => $cart.products_count] d='Shop.Theme.Checkout'}" href="{$cart_url}" style="display: none">
      {/if}
